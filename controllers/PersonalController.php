...
class PersonalController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            ...
            if ($model->load($this->request->post())) {
                $model->tgl_lahir = \Yii::$app->formatter->asDate($model->tgl_lahir, 'yyy-MM-dd'); //code tambahan jika menggunakan kartik datepicker u tanggal lahir
                $model->save();
    ...
    {
        $model = $this->findModel($id_personal);
        $model->tgl_lahir = date('d-M-Y', strtotime($model->tgl_lahir)); //code tambahan jika menggunakan kartik datepicker u tanggal lahir
    ...
    {
        if (($model = Personal::findOne($id_personal)) !== null) {
            return $model;
        }
